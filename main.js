...
/* 
1)event listener for input submission
  grabs ip address input and runs main() with ip address as parameter

  main contains displayInfo and displayMap function, with ip address as parameter

    displayInfo fetches url (using ipAddress)
    targets innertext of respective element and updates accordingly

    displayMap uses ipAddress to display map
